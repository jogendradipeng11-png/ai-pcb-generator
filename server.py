...
def generate():
    ...
    <svg width="700" height="300" style="background:#1e293b; border-radius:8px; border:1px solid #334155;">
      ...
      <text x="80" y="85" fill="black" text-anchor="middle" font-weight="bold">8S Battery</text>
      
      <rect x="200" y="40" width="140" height="80" fill="#0ea5e9" rx="5"/>
      <text x="270" y="75" fill="black" text-anchor="middle" font-weight="bold">CD74HC4067</text>
      <text x="270" y="95" fill="black" text-anchor="middle">MUX</text>
      
      <rect x="400" y="100" width="120" height="60" fill="#0ea5e9" rx="5"/>
      <text x="460" y="135" fill="black" text-anchor="middle" font-weight="bold">INA219</text>
      
      <rect x="580" y="80" width="100" height="100" fill="#38bdf8" rx="5"/>
      <text x="630" y="130" fill="black" text-anchor="middle" font-weight="bold">ESP8266</text>
      ...
      <text x="350" y="280" fill="#94a3b8" text-anchor="middle" font-size="12">AI Generated: """ + prompt[:40] + """</text>
    </svg>
    """
